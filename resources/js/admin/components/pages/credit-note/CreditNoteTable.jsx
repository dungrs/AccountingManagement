...
const getPartyIcon = (partyType) => {
    return partyType === "customer" ? Users : Building2;
};

const getPartyLabel = (partyType) => {
    return partyType === "customer" ? "Khách hàng" : "Nhà cung cấp";
};
                ...
                <TableBody>
                    {data.length > 0 ? (
                        data.map((row, index) => {
                            ...
                            const PartyIcon = getPartyIcon(row.party_type);
                            const partyLabel = getPartyLabel(row.party_type);
                                ...
                                >
                                    ...
                                    <TableCell>
                                        <div className="flex items-center gap-1 text-sm font-medium text-slate-800">
                                            <PartyIcon className="h-3.5 w-3.5 text-blue-500" />
                            ...
                            >
                                <div className="flex flex-col items-center justify-center">
                                    <div className="h-16 w-16 rounded-full bg-gradient-to-r from-blue-100 to-purple-100 flex items-center justify-center mb-4">
                                        <FileUp className="h-8 w-8 text-blue-600/50" />
                                    </div>
                                    <p className="text-slate-600 font-medium text-lg">
                                        Không tìm thấy dữ liệu
                                    </p>
                                    <p className="text-sm text-slate-400 mt-1">
                                        Nhấn nút "Thêm giấy báo có" để tạo mới
                                    </p>
                                </div>
                            </TableCell>
                        </TableRow>
