        ...
        <div className="rounded-md border border-slate-200 overflow-hidden bg-white shadow-sm">
            <Table>
                ...
                <TableBody>
                    {data.length > 0 ? (
                        data.map((row, index) => {
                            const directionInfo = getDirectionBadge(
                                row.direction,
                            );
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <TableCell className="text-center">
                                        <Badge
                                            variant="outline"
                                            className="bg-green-100 font-medium text-green-700 border-green-200 px-3 py-1"
                                        >
                                            {row.rate}%
                                        </Badge>
                                    </TableCell>
                                    ...
                                    <TableCell className="text-center">
                                        <Badge
                                            variant="outline"
                                            className={cn(
                                                "font-medium flex items-center gap-1 w-fit mx-auto",
                                                directionInfo.bg,
                                                directionInfo.text,
                                                directionInfo.border,
                                            )}
                                        >
                            ...
                            >
                                <div className="flex flex-col items-center justify-center">
                                    <div className="h-16 w-16 rounded-full bg-gradient-to-r from-blue-100 to-purple-100 flex items-center justify-center mb-4">
                                        <Receipt className="h-8 w-8 text-blue-600/50" />
                                    </div>
                                    <p className="text-slate-600 font-medium text-lg">
                                        Không có dữ liệu thuế VAT
                                    </p>
                                    <p className="text-sm text-slate-400 mt-1">
                                        Nhấn nút "Thêm thuế VAT" để tạo mới
                                    </p>
                                </div>
                            </TableCell>
                        </TableRow>
