                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                <SelectCombobox
                                    ...
                                    onChange={(v) =>
                                        handleChange("customer_catalogue_id", v)
                                    }
                                    options={customerCatalogues.map((u) => ({
                                        value: u.id,
                                        label: u.name,
                                    }))}
                                    placeholder="Chọn nhóm khách hàng..."
                                    error={errors.customer_catalogue_id?.[0]}
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        className={cn(
                                            "pl-3 pr-10 border-slate-200 focus:border-blue-500 focus:ring-blue-500 transition-all",
                                            errors.password &&
                                                "border-red-500 focus:border-red-500 focus:ring-red-500",
                                        )}
                                    />
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        className={cn(
                                            "pl-3 pr-10 border-slate-200 focus:border-purple-500 focus:ring-purple-500 transition-all",
                                    ...
                                    >
                                        {showPasswordConfirm ? (
                                            <EyeOff className="h-4 w-4 text-slate-400 hover:text-purple-600" />
                                        ) : (
                                            <Eye className="h-4 w-4 text-slate-400 hover:text-purple-600" />
                                        )}
                                    </Button>
                                </div>
                            </div>
