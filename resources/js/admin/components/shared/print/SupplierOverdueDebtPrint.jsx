...
const SupplierOverdueDebtPrint = forwardRef(
    ({ data, systems, filters }, ref) => {
        ...
        const getDueLevel = (days) => {
            // if (days <= 0) return { label: "Chưa đến hạn", color: "#16a34a" };
            // if (days <= 30)
            //     return { label: "Quá hạn 1-30 ngày", color: "#eab308" };
            // if (days <= 60)
            //     return { label: "Quá hạn 31-60 ngày", color: "#f97316" };
            // if (days <= 90)
            //     return { label: "Quá hạn 61-90 ngày", color: "#ef4444" };
            // return { label: "Trên 90 ngày", color: "#b91c1c" };
                        ...
                        {data.map((supplier, index) => {
                            ...
                            return (
                                <tr key={supplier.id}>
                                    ...
                                    >
                                        {formatMoney(supplier.closing_balance)}
                                    </td>
                                    <td
                                        style={{
                                            ...tdStyle,
...
SupplierOverdueDebtPrint.displayName = "SupplierOverdueDebtPrint";
export default SupplierOverdueDebtPrint;