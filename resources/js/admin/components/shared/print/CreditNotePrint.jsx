...
/**
 * CreditNotePrint — Giấy báo có (Phiếu ghi có)
 * Căn cứ pháp lý:
 *   • Thông tư 99/2025/TT-BTC ngày 27/10/2025 (hiệu lực 01/01/2026)
 *   • Mẫu số 06 - BC (Giấy báo có)
 */
const CreditNotePrint = forwardRef(
            ...
            >
                ...
                <div className="flex justify-between items-start mb-6">
                    ...
                    <div className="text-right" style={{ width: "35%" }}>
                        <p className="font-bold">Mẫu số: 06 - BC</p>
                    ...
                    >
                        ...
                        <tbody>
                            <tr>
                                ...
                                >
                                    {getReason() || "Nhận tiền từ khách hàng"}
                                </td>
                                <td
                                    style={{
                                        border: "1px solid #000",
