...
const SupplierDebtSummaryPrint = forwardRef(
                    ...
                    <tbody>
                        {data.data?.map((supplier, index) => (
                            <tr key={supplier.id}>
                                ...
                                {/* Phát sinh trong kỳ */}
                                <td style={{ ...tdStyle, textAlign: "right" }}>
                                    {formatMoney(supplier.total_debit)}
                                </td>
                                <td style={{ ...tdStyle, textAlign: "right" }}>
                                    {formatMoney(supplier.total_credit)}
                                </td>
...
SupplierDebtSummaryPrint.displayName = "SupplierDebtSummaryPrint";
export default SupplierDebtSummaryPrint;