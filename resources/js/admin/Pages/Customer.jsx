...
import CustomerTable from "@/admin/components/pages/customer/CustomerTable";
import CustomerFormModal from "@/admin/components/pages/customer/CustomerFormModal";
...
export default function Home() {
        ...
        async (page = 1) => {
            ...
            try {
                ...
                const mappedData = response.data.map((item) => ({
                    ...
                    customer_catalogue_id: item.customer_catalogue_id || "",
                    customer_catalogue_name: item.customer_catalogue_name || "",
                }));
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            const res = await axios.post(route("admin.customer.delete"), {
                id: deletingRow.id,
            });
            ...
            <Card className="rounded-md shadow-sm">
                ...
                <CardHeader className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <CardDescription>
                            Quản lý thông tin khách hàng, phân loại nhóm và trạng thái hoạt động trong hệ thống.
                        </CardDescription>
                    </div>
