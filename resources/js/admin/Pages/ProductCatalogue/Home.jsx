...
import ProductCatalogueTable from "@/admin/components/product-catalogue/ProductCatalogueTable";
                ...
                <CardHeader className="pb-4">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <CardDescription>
                                Quản lý nhóm sản phẩm theo cấp bậc,
                                hỗ trợ lọc và hiển thị sản phẩm theo nhóm.
                            </CardDescription>
                        </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <SelectContent>
                                ...
                                <SelectItem value="1">Đang hiển thị</SelectItem>
                                <SelectItem value="0">Đang ẩn</SelectItem>
                            </SelectContent>
                        </Select>
                    </DataTableFilter>
