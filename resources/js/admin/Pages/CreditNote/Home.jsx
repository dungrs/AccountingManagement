...
import CreditNoteTable from "@/admin/components/pages/credit-note/CreditNoteTable";

export default function CreditNoteHome() {
    useFlashToast();
        ...
        async (page = 1) => {
            ...
            try {
                ...
                const res = await axios.post(
                    route("admin.note.credit.filter"),
                    params,
                );
                ...
                console.log("Dữ liệu giấy báo có:", mappedData);
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            const res = await axios.post(
                route("admin.note.credit.delete", deletingRow.id),
            );
    ...
    return (
        <AdminLayout
            breadcrumb={[
                ...
                {
                    label: "Quản Lý Giấy Báo Có",
                },
            ]}
        >
            <Head title="Quản Lý Giấy Báo Có" />
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <CardDescription className="text-white/80">
                                Quản lý danh sách giấy báo có, khách hàng/nhà cung cấp, số tiền và trạng thái.
                            </CardDescription>
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Button
                                ...
                                onClick={() =>
                                    router.visit(
                                        route("admin.note.credit.create"),
                                    )
                                }
                            >
            ...
            <ConfirmDeleteDialog
                ...
                title="Xóa giấy báo có"
                description={`Bạn có chắc chắn muốn xóa giấy báo có "${deletingRow?.code}" không?`}
                onCancel={() => {
                    setOpenDeleteDialog(false);
                    setDeletingRow(null);
                }}
