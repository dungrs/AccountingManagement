...
export default function GeneralLedgerIndex({ initialFilters, accounts }) {
    ...
    return (
        ...
        >
            ...
            {/* Period Info - Giống cashbook */}
            <div className="mb-6 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-white/80 text-sm mt-1 flex items-center gap-2">
                                ...
                                <span>
                                    Từ ngày {period.start_date || startDate}
                                </span>
                                <span>→</span>
                                <span>
                                    đến ngày {period.end_date || endDate}
                                </span>
                            </p>
                        </div>
                    </div>
                ...
                <CardContent className="p-6 space-y-6">
                    ...
                    <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
                        ...
                        <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-end">
                            ...
                            <Button
                                onClick={fetchData}
                                className="btn-gradient-premium min-w-[120px]"
                                disabled={loading}
                            >
                                {loading ? (
                        ...
                        <div className="flex flex-wrap items-center gap-2 mt-4 pt-3 border-t border-slate-200">
                            ...
                            {quickRanges.map((range, index) => (
                                <Button
                                    ...
                                    className="text-xs border-slate-200 hover:bg-blue-50 hover:text-blue-600 hover:border-blue-200 transition-all"
                                >
                                    {range.label}
                                </Button>
                            ))}
