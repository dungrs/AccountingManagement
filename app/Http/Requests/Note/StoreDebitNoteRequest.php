...
class StoreDebitNoteRequest extends FormRequest
{
    ...
    protected function baseRules(): array
    {
        return [
            ...
            'code'             => ['nullable', 'string', 'max:50', 'unique:debit_notes,code'],
            ...
            'type'             => ['required', 'in:sales_return,discount_after,price_adjustment,penalty,interest,other'],
    ...
    public function messages(): array
    {
        return [
            ...
            'journal_entries.required' => 'Giấy báo nợ phải có bút toán.',
            'journal_entries.array'    => 'Bút toán không hợp lệ.',
            'journal_entries.min'      => 'Giấy báo nợ phải có ít nhất 2 dòng bút toán.',
            ...
            'code.unique' => 'Mã giấy báo nợ đã tồn tại trong hệ thống.',
        ];
    }
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            // Kiểm tra phải có ít nhất một đối tượng (khách hàng hoặc nhà cung cấp)
    ...
    {
        // Tính toán VAT amount và total amount nếu có amount và vat_rate
